    ...
    public void copyIntoIntentExtras(Activity activity)
    {
        ...
        do
        {
            ...
            if (s1 != null)
            {
                ...
                {
                    int i1 = activity.getResources().getIdentifier(s1, "drawable", activity.getClass().getPackage().getName());
                    int i = i1;
                    if (i1 == 0)
                    {
                        i = activity.getResources().getIdentifier(s1, "drawable", activity.getPackageName());
                    }
