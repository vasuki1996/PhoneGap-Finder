...
//            CordovaBridge, PluginManager, CordovaClientCertRequest, CordovaHttpAuthHandler, 
//            CordovaInterface
...
public class CordovaWebViewClient extends WebViewClient
{
    ...
    public void onPageFinished(WebView webview, String s)
    {
        ...
        if (isCurrentlyLoading || s.startsWith("about:"))
        {
    ...
    {
        PluginManager pluginmanager = appView.pluginManager;
        if (pluginmanager != null && pluginmanager.onReceivedClientCertRequest(appView, new CordovaClientCertRequest(clientcertrequest)))
        {
            webview = appView;
            webview.loadUrlTimeout = ((CordovaWebView) (webview)).loadUrlTimeout + 1;
            return;
    ...
    {
        Object obj = getAuthenticationToken(s, s1);
        if (obj != null)
        {
            httpauthhandler.proceed(((AuthenticationToken) (obj)).getUserName(), ((AuthenticationToken) (obj)).getPassword());
            return;
        }
        obj = appView.pluginManager;
        if (obj != null && ((PluginManager) (obj)).onReceivedHttpAuthRequest(appView, new CordovaHttpAuthHandler(httpauthhandler), s, s1))
        {
            webview = appView;
            webview.loadUrlTimeout = ((CordovaWebView) (webview)).loadUrlTimeout + 1;
            return;
