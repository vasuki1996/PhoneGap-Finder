...
//            CordovaPlugin, CordovaWebView, PluginResult, CallbackContext, 
...
public class App extends CordovaPlugin
{
    ...
    private void initTelephonyReceiver()
    {
        ...
        webView.getContext().registerReceiver(telephonyReceiver, intentfilter);
    }

    private void sendEventMessage(String s)
    {
        ...
        {
            LOG.e("CordovaApp", "Failed to create event message", s);
        }
        s = new PluginResult(PluginResult.Status.OK, jsonobject);
        s.setKeepCallback(true);
        if (messageChannel != null)
        {
            messageChannel.sendPluginResult(s);
        }
    }
...
label3:
        ...
        catch (String s)
        {
          ...
          goto _L3
        if (!s.equals("messageChannel")) goto _L3; else goto _L7
_L7:
    ...
    public void fireJavascriptEvent(String s)
    {
        sendEventMessage(s);
    }
...
_L3:
    ...
    {
        webView.getContext().unregisterReceiver(telephonyReceiver);
    }
