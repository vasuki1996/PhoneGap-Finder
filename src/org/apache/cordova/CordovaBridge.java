...
public class CordovaBridge
{
    ...
    public CordovaBridge(PluginManager pluginmanager, NativeToJsMessageQueue nativetojsmessagequeue, String s)
    {
        expectedBridgeSecret = -1;
        pluginManager = pluginmanager;
        jsMessageQueue = nativetojsmessagequeue;
        appContentUrlPrefix = (new StringBuilder()).append("content://").append(s).append(".").toString();
    }
    ...
    {
        expectedBridgeSecret = (new SecureRandom()).nextInt(0x7fffffff);
...
_L2:
        ...
        {
            if (s.startsWith("file:") || s.startsWith(appContentUrlPrefix) || s.startsWith("http") && loadedUrl.startsWith(s))
            {
