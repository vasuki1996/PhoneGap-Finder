    ...
    implements android.content.ickListener
{
    ...
    // Unreferenced inner class org/apache/cordova/CordovaActivity$3

/* anonymous class */
    class CordovaActivity._cls3
        implements Runnable
    {
        ...
        public void run()
        {
            try
            {
                ...
                builder.setPositiveButton(button, new CordovaActivity._cls3._cls1());
                builder.create();
                builder.show();
                return;
            }
