...
public class CordovaChromeClient extends WebChromeClient
{
    ...
    public boolean onJsAlert(WebView webview, String s, String s1, final JsResult result)
    {
        ...
        lastHandledDialog = webview.show();
        return true;
    }
    ...
    public boolean onShowFileChooser(WebView webview, final ValueCallback filePathsCallback, android.webkit.WebChromeClient.FileChooserParams filechooserparams)
    {
        ...
        try
        {
            cordova.startActivityForResult(new CordovaPlugin() {
                ...
                {
                    intent = android.webkit.WebChromeClient.FileChooserParams.parseResult(j, intent);
                    Log.d(TAG, (new StringBuilder()).append("Receive file chooser URL: ").append(intent).toString());
                    filePathsCallback.onReceiveValue(intent);
                }
        ...
        {
            Log.w("No activity found to handle file chooser intent.", webview);
    ...
    public void openFileChooser(final ValueCallback uploadMsg, String s, String s1)
    {
        ...
        cordova.startActivityForResult(new CordovaPlugin() {
            ...
            public void onActivityResult(int i, int j, Intent intent)
            {
                ...
                Log.d(TAG, (new StringBuilder()).append("Receive file chooser URL: ").append(intent).toString());
                uploadMsg.onReceiveValue(intent);
            }
